...
#8 taxa with more than 1 interaction
...
for(t in 1:length(traits)) {
	...
	for(i in 1:nrow(res_sig)) {
		...
		png(paste0("/rs/rs_grp_ibdeqtl/FastQTL/rectum_protein_coding_residuals/qnorm_residuals_analysis/GxM_abundance/plots/interaction_plots/scatterplots/Abundance_GxM_19PCs_Interaction_eQTL_Scatterplot_", trait,"_",gene_symbol, ".png"))
...
for(t in 1:length(traits)) {
	...
	for(i in 1:nrow(res_sig)) {
		...
		df$genotype <- factor(df$genotype, levels=(c(paste0(gt_data$ref, "/", gt_data$ref), paste0(gt_data$ref, "/", gt_data$alt),paste0(gt_data$alt, "/", gt_data$alt))))
		png(paste0("/rs/rs_grp_ibdeqtl/FastQTL/rectum_protein_coding_residuals/qnorm_residuals_analysis/GxM_abundance/plots/interaction_plots/tertile_boxplots/Abundance_GxM_19PCs_Interaction_eQTL_tertile_boxplot_", trait, "_",gene_symbol,".png"))
