...
for(t in 1:length(traits)) {
	trait <- traits[t]
	results <- read.table(paste0("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/IBD-eQTL_Ileum_GxE_presence_absence_20PCs_", trait, ".txt"), sep="\t", header=TRUE, stringsAsFactors=FALSE)
	...
	for(i in 1:nrow(res_sig)) {
		...
		png(paste0("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/plots/interaction_plots/Ileum_Interaction_eQTL_plots_", trait,"_",gene_symbol, "_GxE_presence_absence_20PCs.png"))
...
vars <- read.table("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/ileum_microbe_covariates/presence-absence-1-per-var-list.txt", sep="\t", comment="=", blank.lines.skip=T)

colnames(vars) <- "Var"

fname=paste0("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/IBD-eQTL_Ileum_GxE_presence_absence_20PCs_", vars$Var[1], ".txt")
...
for(i in 1:length(vars$Var)) {
	var <- vars$Var[i]
	fname=paste0("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/IBD-eQTL_Ileum_GxE_presence_absence_20PCs_", var, ".txt")
	res <- read.table(fname, sep="\t", stringsAsFactors=F, header=T, comment="")
	res$var <- var
...
write.table(res_all, file=paste0("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/Ileum_GxE_presence_absence_all_results_20PCs.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)

all_results_presence_absence <- read.table("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/Ileum_GxE_presence_absence_all_results_20PCs.txt", sep="\t", stringsAsFactors=F, header=T, comment="")
...
write.table(gene_taxa_sig, file="/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/Ileum_GxM_presence_absence_20PCs_sig_genes_and_taxa_summary.txt", sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)

genes <- res_sig %>% select(pid, symbol) %>% unique()
dim(genes)
#7 2

write.table(genes, file="/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/Ileum_GxM_presence_absence_19PCs_sig_genes.txt", sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
microbe_short <- c("Verrucomicrobia", "Deltaproteobacteria", "Acidaminococcaceae", "Dorea", "Lachnospira", "Lachnospiraceae_NK4A136_group", "Ruminiclostridium_6", "Akkermansia")
gene_list <- c()
...
for(i in 1:length(traits)) {
	trait <- traits[i]
	fname=paste0("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/GxE_results/IBD-eQTL_Ileum_GxE_presence_absence_20PCs_", trait, ".txt")
	res <- read.table(fname, sep="\t", stringsAsFactors=F, header=T, comment="")
	res$microbe <- trait
...
write.table(taxa_id_table, file="/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/plots/interaction_plots//significant_taxa_id_table.txt", sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
library(pheatmap)
pdf("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/plots/interaction_plots//GxM_dichotomous_interaction_effect_correlation_heatmap.pdf") 
p <- pheatmap(res_sc_cor_val, fontsize = 9)
print(p) 
dev.off()

pdf("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/plots/interaction_plots//GxM_dichotomous_interaction_effect_signficant_correlation_heatmap.pdf") 
...
pdf("/rs/rs_grp_ibdeqtl/FastQTL/ileum_protein_coding_residuals/qnorm_residual_analysis/GxM_presence_absence/plots/interaction_plots//GxM_dichotomous_normalized_IE_correlation_heatmap_significant.pdf") 
